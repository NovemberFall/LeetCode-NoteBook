...
public class LRUCache {
    ...
    //HashMap contain such every a element that contains <key, Node>, Node => <key, value>
    ...
    public int get(int key) {
        ...
        //Even though we just read from linkedList, but we still need to
    ...
    /**
     * there are 4 cases for doubly linkedList to maintain its order
     * @param node the current node that we need to remove from double LinkedList
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Should return 1 => " + temp);  // return 1
        lRUCache.put(3, 3);
        lRUCache.put(4, 4);
        lRUCache.put(5, 5);
        lRUCache.put(6, 6); // evicts key 2, cache is {1=1, 3=3, 4=4, 5=5, 6=6}
        ...
        lRUCache.put(7, 7); // evicts key 1, cache is {3=3, 4=4, 5=5, 6=6, 7=7}
        lRUCache.map.forEach((key, node) -> System.out.println(key + " => " + node.value));
